    ...
    <main className="min-h-screen bg-[#060815] text-white">
      ...
      <section className="border-b border-white/10 bg-gradient-to-b from-slate-950 via-[#060815] to-[#060815]">
        <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-10 md:flex-row md:items-center md:justify-between md:py-14">
          ...
          <div className="max-w-sm rounded-2xl border border-teal-300/40 bg-teal-300/5 p-5 text-xs text-teal-100">
            <p className="text-[0.7rem] font-semibold uppercase tracking-[0.2em] text-teal-200">
              How it works
            </p>
            <ul className="mt-2 space-y-2 text-teal-50">
      ...
      <section className="mx-auto grid max-w-6xl gap-8 px-6 py-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] lg:py-14">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-white/10 bg-slate-950/80 p-6 text-xs text-slate-300">
        ...
        <form
          ...
          className="space-y-4 rounded-2xl border border-white/10 bg-slate-950/90 p-6 shadow-[0_0_40px_rgba(0,0,0,0.7)]"
        >
          <h2 className="text-sm font-semibold text-slate-50">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <div>
              ...
              <input
                type="text"
                className="w-full rounded-lg border border-white/10 bg-[#060815] px-3 py-2 text-sm text-white outline-none focus:border-teal-200/45"
                value={name}
          ...
          <div>
            ...
            <textarea
              className="h-24 w-full resize-none rounded-lg border border-white/10 bg-[#060815] px-3 py-2 text-sm text-white outline-none focus:border-teal-200/45"
              value={details}
          ...
          <div>
            ...
            <textarea
              className="h-20 w-full resize-none rounded-lg border border-white/10 bg-[#060815] px-3 py-2 text-sm text-white outline-none focus:border-teal-200/45"
              value={availability}
